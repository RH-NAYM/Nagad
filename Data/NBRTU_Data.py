import torch
nbrtuModel = torch.hub.load('yolov5', 'custom', path='AI_Models/Nagad_AI_V4.pt', source='local', device=0)
# nbrtuModel.conf = 0.4
# nbrtuModel.iou = 0.2
...
rocket_items = [
                    ...
                    'rocket_sticker_table_price', 
                    'rocket_table_top_qr_1_pvc',
                    'rocket_fastoon_wasa_bill', # new version not decided
                    'rocket_fastoon_bill_pay_new', # new version not decided
                    'rocket_fastoon_pdb_bill', # new version not decided
                    'rocket_fastoon_lenden_new', # new version not decided
                    'rocket_fastoon_polli_biddut', # new version not decided
                    'rocket_fastoon_remittance' # new version not decided
                ]
...
upay_items = [
                ...
                'upay_sticker_qr_code_2', 
                'upay_sticker_shutter',
                'upay_fastoon_dpdc', # new version not decided
                'upay_fastoon_price_new', # new version not decided
                'upay_fastoon_water_bill' # new version not decided
            ]
